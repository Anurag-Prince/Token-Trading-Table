...
const MOCK_TOKENS: Token[] = [
  ...
  },
  {
    ...
    volume24h: 62000000,
    column: "Migrated",
    history: [3.1, 3.15, 3.2, 3.18, 3.24, 3.26, 3.24],
    liquidity: 12000000,
    holders: 19870,
    transactions24h: 12340,
  },
  {
    id: "4",
    name: "MoonRocket",
    ...
    volume24h: 28000000,
    column: "New pairs",
    history: [0.046, 0.044, 0.043, 0.0425, 0.041, 0.042, 0.0425],
    liquidity: 3500000,
    holders: 8920,
    transactions24h: 6540,
  },
  {
    id: "5",
    name: "StarLink",
    ...
    volume24h: 115000000,
    column: "Final Stretch",
    history: [5.5, 5.55, 5.6, 5.58, 5.67, 5.7, 5.67],
    liquidity: 22000000,
    holders: 45670,
    transactions24h: 23450,
  },
  {
    id: "6",
    name: "EcoChain",
    ...
    volume24h: 71000000,
    column: "Migrated",
    history: [2.22, 2.2, 2.18, 2.19, 2.17, 2.18, 2.18],
    liquidity: 13500000,
    holders: 24560,
    transactions24h: 14780,
  },
  {
    id: "7",
    name: "VelocityX",
    ...
    volume24h: 48000000,
    column: "New pairs",
    history: [0.14, 0.145, 0.15, 0.152, 0.156, 0.158, 0.156],
    liquidity: 7800000,
    holders: 15670,
    transactions24h: 9870,
  },
  {
    id: "8",
    name: "BlockForce",
  ...
  ({ path, color }: { path: string; color: "green" | "red" }) => (
    <svg viewBox="0 0 100 30" className="w-24 h-8">
      <path
        ...
        strokeWidth="2"
        d={path}
        className={color === "green" ? "text-emerald-500" : "text-rose-500"}
      />
    </svg>
  )
);
  ...
  ({
    ...
    useEffect(() => {
      if (previousChange !== null && value !== previousChange) {
        const flash =
          value > previousChange ? "bg-emerald-500/10" : "bg-rose-500/10";
        setFlashClass(flash);
  ...
  ({
    ...
    useEffect(() => {
      if (previousPrice !== null && price !== previousPrice) {
        const flash =
          price > previousPrice ? "bg-emerald-500/10" : "bg-rose-500/10";
        setFlashClass(flash);
        const timer = setTimeout(() => setFlashClass(""), 500);
        return () => clearTimeout(timer);
      }
    ...
    return (
      <div
        className={`transition-all duration-500 rounded px-2 py-1 ${flashClass}`}
      >
        <span className="font-bold text-zinc-100">{formatCurrency(price)}</span>
      </div>
    );
  }
);
...
const Tooltip = ({
  ...
  return (
    <div className="relative inline-block">
      ...
      {show && (
        <div className="absolute z-50 px-3 py-2 text-xs font-medium text-zinc-100 bg-zinc-800 rounded-lg shadow-lg border border-zinc-700 -top-10 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
          {content}
          <div className="absolute w-2 h-2 bg-zinc-800 transform rotate-45 -bottom-1 left-1/2 -translate-x-1/2 border-r border-b border-zinc-700"></div>
        </div>
      )}
    </div>
  );
...
const Popover = ({ token }: { token: Token }) => {
  ...
  return (
    <div className="relative">
      ...
      >
        <Info className="w-4 h-4 text-zinc-400 hover:text-zinc-200" />
      </button>
      {show && (
        <>
          <div className="fixed inset-0 z-40" onClick={() => setShow(false)} />
          <div className="absolute z-50 w-64 p-4 bg-zinc-800 rounded-lg shadow-xl border border-zinc-700 -right-2 top-8">
            <div className="space-y-3">
              <div className="flex justify-between items-start">
                <h3 className="font-semibold text-zinc-100">Token Details</h3>
                <button
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  <span className="text-zinc-400">24h Transactions:</span>
                  <span className="font-medium text-zinc-100">
...
const Modal = ({
  ...
  return (
    ...
    >
      <div
        className="bg-zinc-800 rounded-xl shadow-2xl border border-zinc-700 max-w-2xl w-full max-h-[90vh] overflow-y-auto"
      ...
      >
        ...
        <div className="p-6 space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="p-4 bg-zinc-700/50 rounded-lg border border-zinc-700">
          ...
          <button className="w-full py-3 bg-gradient-to-r from-amber-500 to-orange-600 hover:from-amber-600 hover:to-orange-700 text-white font-semibold rounded-lg transition-all shadow-lg shadow-amber-500/20 flex items-center justify-center space-x-2">
...
const TokenRow = memo(
  ({
    ...
    return (
      <tr
        className="border-b border-zinc-700 hover:bg-zinc-700/50 transition-colors cursor-pointer group"
        onClick={onClick}
      >
        <td className="py-4 px-4 lg:px-6">
          <div className="flex items-center space-x-3">
            ...
            <div>
              <div className="font-semibold text-zinc-100">{token.name}</div>
        ...
        <td className="py-4 px-4 lg:px-6 text-zinc-300 font-medium hidden lg:table-cell">
          {formatCurrency(token.marketCap)}
        </td>

        <td className="py-4 px-4 lg:px-6 text-zinc-300 hidden xl:table-cell">
          {formatCurrency(token.volume24h)}
        </td>
        ...
        <tr className="bg-zinc-700/50 border-b border-zinc-700">
          {headers.map((header) => (
            <th
              ...
              className={`py-3 px-4 lg:px-6 text-left text-xs font-semibold text-zinc-400 uppercase tracking-wider ${
                header.sortable ? "cursor-pointer hover:bg-zinc-600" : ""
              } ${header.className || ""}`}
            >
...
const TokenTradingTable = () => {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 relative overflow-hidden text-zinc-100">
      <div className="relative z-10 max-w-[1600px] mx-auto p-4 sm:p-6 lg:p-8">
        ...
        <div className="mb-6 flex flex-col sm:flex-row gap-4">
          <div className="flex-1 relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 bg-zinc-800 border border-zinc-700 rounded-lg text-zinc-100 placeholder-zinc-400 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all"
            />
          </div>
        ...
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-4">
          <div className="bg-zinc-800 rounded-lg shadow-xl p-4 border border-zinc-700">
          ...
          <div className="bg-zinc-800 rounded-lg shadow-xl p-4 border border-zinc-700">
            <div className="text-sm text-zinc-400 mb-1">24h Volume</div>
            <div className="text-2xl font-bold text-zinc-100">
        ...
        <div className="mt-8 p-6 bg-zinc-800 border border-zinc-700 rounded-xl">
          <h3 className="font-bold text-zinc-100 mb-3 text-lg">
          ...
          <div className="grid sm:grid-cols-2 gap-3 text-sm text-zinc-300">
            <div className="flex items-start space-x-2">
              ...
              <span>
                <strong className="text-zinc-100">Atomic Design:</strong>{" "}
            ...
            <div className="flex items-start space-x-2">
              <span className="text-amber-500 font-bold">✓</span>
              <span>
                <strong className="text-zinc-100">Performance:</strong>{" "}
            ...
            <div className="flex items-start space-x-2">
              <span className="text-amber-500 font-bold">✓</span>
              <span>
                <strong className="text-zinc-100">Real-time Updates:</strong>{" "}
            ...
            <div className="flex items-start space-x-2">
              <span className="text-amber-500 font-bold">✓</span>
              <span>
                <strong className="text-zinc-100">Interactions:</strong>{" "}
                Tooltip, Popover, Modal, Sorting, Filtering
              </span>
            </div>
            <div className="flex items-start space-x-2">
              <span className="text-amber-500 font-bold">✓</span>
              <span>
                <strong className="text-zinc-100">Responsive:</strong> 320px+
            ...
            <div className="flex items-start space-x-2">
              <span className="text-amber-500 font-bold">✓</span>
              <span>
                <strong className="text-zinc-100">Loading States:</strong>{" "}
                Skeleton loaders
              </span>
            </div>
          </div>
